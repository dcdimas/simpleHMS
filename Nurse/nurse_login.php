...
<head>
	...
	<link rel="stylesheet" type="text/css" href="nurse_login.css">
</head>
<body>
		<div class="heading">
			<img src="images/hospital.png" id="hospital"> 
			<h1 id="welcome">Nurse | Log in</h1>
		</div>
	...
	<?php endif?>
		...
		<p style="font-size: 15px">Doesn't have an account? <a href="nurse_register.php">Sign up here.</a></p>
