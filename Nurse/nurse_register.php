...
<head>
	...
	<link rel="stylesheet" type="text/css" href="nurse_register.css">
</head>
<body>

		<div class="heading">
			<img src="images/hospital.png" id="hospital"> 
			<h2 id="welcome">Nurse | Register here</h2>
		</div>

	<form action="nurse_register.php" method="post">
	<?php include('errors.php'); ?> 
		...
		<p>Already have an account? <a href="nurse_login.php"class="none">Log in.</a></p>
	</form>
