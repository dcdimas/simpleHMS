...
<body>
	...
	<div id="username" style="font-family: arial; color: white; text-align: center; justify-content: center; line-height: 45px; 	</h1>
	...
	<div class="area">
		<h1 class="htitle">Patient | Delete</h1>
	<form action="remove_patient.php" method="post" class="form">
		<div class="edit">
			<label for="pID">Patient ID:</label>
			<input type="text" name="pID" required/>
		</div>
		<input type="submit" name="removep" value="Delete" class="btn" style="background: red;">
		...
		<?php
			if (isset($_POST['removep'])) {
				...
				mysqli_query($db, "DELETE FROM patient_register WHERE ID = '$id'" );
