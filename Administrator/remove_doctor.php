...
<body>
	...
	<div class="area">
		<h1 class="htitle">Doctor | Delete</h1>
	<form action="remove_doctor.php" method="post" class="form">
		<div class="edit">
			<label for="pID">Doctor ID:</label>
			<input type="text" name="pID" required/>
		</div>
		<input type="submit" name="removed" value="Delete" class="btn" style="background: red;">
		...
		<?php
			if (isset($_POST['removed'])) {
				...
				mysqli_query($db, "DELETE FROM doctor_register WHERE ID = '$id'" );
