...
<body>
	...
	<div class="area">
		<h1 class="htitle">Wardboy | Delete</h1>
	<form action="remove_wb.php" method="post" class="form">
		<div class="edit">
			<label for="pID">Wardboy ID:</label>
			<input type="text" name="pID" required/>
		</div>
		<input type="submit" name="removew" value="Delete" class="btn" style="background: red;">
		...
		<?php
			if (isset($_POST['removew'])) {
				...
				mysqli_query($db, "DELETE FROM wb_register WHERE ID = '$id'" );
				 $_SESSION['msgsadmin'] =  "Removed succesfully!";
				header('location: wardboy_list.php');
			}
		?>
