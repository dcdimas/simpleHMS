...
<body>
	...
	<div class="area">
		<h1 class="htitle">Admin | Delete</h1>
	<form action="remove_admin.php" method="post" class="form">
		<div class="edit">
			<label for="pID">Admin ID:</label>
			<input type="text" name="pID" required/>
		</div>
		<input type="submit" name="removea" value="Delete" class="btn" style="background: red;">
		...
		<?php
			if (isset($_POST['removea'])) {
				...
				mysqli_query($db, "DELETE FROM admin_login WHERE ID = '$id'" );
