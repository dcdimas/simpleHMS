...
<body>
	...
	<div id="search">
			...
			$search = $_POST['search'];
			$sql = "SELECT DISTINCT ID, nFull_name, nBirthday, nSchedule, nAddress, nContact_no, nEmail_Add FROM nurse_register  WHERE nFull_name LIKE '%$search%'";
		}else{
			$sql = "SELECT DISTINCT ID, nFull_name, nBirthday, nSchedule, nAddress, nContact_no, nEmail_Add FROM nurse_register ";
			$search ="";
		}
			...
			<table class="tbl" width="80%">
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr class="tr">
						...
						<td class="td"><a href="remove_nurse.php" style="text-decoration: none;">Delete</a></td>
					</tr>
				<?php } ?>
				</table>
	</div>
