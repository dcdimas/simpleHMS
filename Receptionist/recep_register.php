...
<head>
	...
	<link rel="stylesheet" type="text/css" href="recep_register.css">
</head>
<body>

		<div class="heading">
			<img src="images/hospital.png" id="hospital"> 
			<h2 id="welcome">Receptionist | Register here</h2>
		</div>

	<form action="recep_register.php" method="post">
	...
	<div class="register">
		...
		<p>Already have an account? <a href="recep_login.php"class="none">Log in.</a></p>
	</form>
