<?php 
 ...
 if (count($errors) == 0) {
  	...
  	mysqli_query ($db, "INSERT INTO recep_register (rFull_name, rBirthday, rSchedule, rAddress, rContact_no, rEmail_Add, rUsername, rPassword) VALUES ('$Full_name', '$Birthday', '$Schedule', '$Address', '$Contact_no', '$Email_Add','$Username', '$Password1')");
  	 $_SESSION['messrec'] = "Registered successfully! Log in first.";
    header('location: recep_login.php');
